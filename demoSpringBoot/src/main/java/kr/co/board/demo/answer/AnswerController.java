...
public class AnswerController {
	...
	public String createAnswer(Model model, @PathVariable("id") Integer id, @Valid AnswerForm answerForm, BindingResult bindingResult, Principal principal) {
		...
		Answer answer = this.answerService.create(question, answerForm.getContent(), bbsUser);
	...
	public String answerModify(AnswerForm answerForm, @PathVariable("id") Integer id, Principal principal) {
		...
		if(!answer.getBbsUser().getUsername().equals(principal.getName())) {
	...
	public String answerVote(Principal principal, @PathVariable("id") Integer id) {
		Answer answer = this.answerService.getAnswer(id);
		BbsUser bbsUser = this.userService.getUser(principal.getName());
		this.answerService.vote(answer, bbsUser);
		return String.format("redirect:/question/detail/%s#answer_%s", answer.getQuestion().getId(), answer.getId());
	}
}
